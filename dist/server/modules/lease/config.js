...
export const CONCURRENCY_SCOPES = ["session", "machine", "user"];
...
export function resolveScope(raw, dflt = DEFAULT_SCOPE) {
    return CONCURRENCY_SCOPES.includes(raw) ? raw : dflt;
}
/**
 ...
 */
export function effectiveCap(maxConcurrent, overageAllowance) {
 ...
 */
export function isOverageSeat(liveCountBefore, maxConcurrent) {
 ...
 */
export function canAdmit(liveCountBefore, maxConcurrent, overageAllowance) {
...
export function loadLeaseConfig(env = process.env) {
